          ...
          {items.map((c, index) => (
            <div
              ...
              className="
                ...
                relative group overflow-hidden cursor-pointer rounded-xl
            ...
            >
              <img
                src={c.image}
                alt={c.name}
                className="w-full h-72 object-cover transition duration-500 group-hover:scale-110 pointer-events-none"
              />
